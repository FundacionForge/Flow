...
export const PILL_LABELS = {
  ...
  'P5-B': 'Foco solo en la nota/resultado',
  'P6-A': 'Pesimismo previo a la tarea',
  'P6-D': 'Frustración cuando no sale',
  'P7-C': 'Tener ejercicios para practicar',
  'P8-A': 'Aprender de memoria',
  ...
  'P12-C': 'Incomodidad ante el conflicto',
  'P12-D': 'Evitar conflictos grupales',
  'P11-D': 'Esperar antes de participar',
};
